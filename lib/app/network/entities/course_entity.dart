...
class CourseEntity {
  ...
  factory CourseEntity.fromFirestore(DocumentSnapshot<Map<String, dynamic>> doc, SnapshotOptions? _) {
    final d = doc.data()!;
    return CourseEntity(
      courseId: doc.id,
      courseTitle: d['courseTitle'] as String? ?? 'Untitled',
      ...
      metadata: CourseMetadata.fromMap(d['metadata'] as Map<String, dynamic>? ?? {}),
    );
  }
  ...
  static Map<String, dynamic> createMap(String courseId, CreateCourseInput input) => {
    'courseId': courseId,
...
class CourseMetadata {
  ...
  const CourseMetadata({this.author, this.color, this.thumbnails = const {}});

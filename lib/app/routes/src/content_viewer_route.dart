...
final contentViewerRoutes = [
  GoRoute(
    ...
    builder: (context, state) =>
        PdfDocViewer(content: state.extra as ModuleContent),
  ),
  GoRoute(
    ...
    builder: (context, state) =>
        ImageViewer(content: state.extra as ModuleContent),
  ),
  ...
  GoRoute(
    ...
    builder: (context, state) {
      ...
      return DriveListingView(
        initialFolderId: content.path.url,
  ...
  GoRoute(
    ...
    builder: (context, state) =>
        TextDocViewer(content: state.extra as ModuleContent),
  ),
];

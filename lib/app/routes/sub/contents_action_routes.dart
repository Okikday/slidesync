...
final contentActionsRoutes = [
  GoRoute(
    ...
    builder: (context, state) {
      final contents = Result.from(
        () => state.extra as List<ModuleContent>,
        fallback: null,
      );
      if (contents == null)
        return _fallbackContentActionScreen('Unable to start move action');
  ...
  GoRoute(
    ...
    builder: (context, state) {
      ...
      if (contents == null)
        return _fallbackContentActionScreen('Unable to start copy action');
  ...
  GoRoute(
    ...
    builder: (context, state) {
      final filePaths = Result.from(
        () => state.extra as List<String>,
        fallback: null,
      );
      if (filePaths == null)
        return _fallbackContentActionScreen('Unable to start store action');

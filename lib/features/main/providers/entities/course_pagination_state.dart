...
class CoursePaginationState {
  ...
  const CoursePaginationState({this.sortOption = CourseSortOption.dateModifiedAsc, this.isLoading = false});

  CoursePaginationState copyWith({CourseSortOption? sortOption, bool? isLoading}) {

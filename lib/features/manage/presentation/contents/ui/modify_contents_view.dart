...
import 'package:slidesync/features/manage/presentation/contents/ui/modify_contents/mod_content_search_view_button.dart';
import 'package:slidesync/features/manage/presentation/contents/ui/modify_contents/modify_content_list_view.dart';
import 'package:slidesync/features/manage/presentation/contents/ui/modify_contents/modify_contents_header.dart';
                  ...
                  onMoveContents: () async {
                    await showModalBottomSheet(
                      ...
                      builder: (context) {
                        ...
                        // mcvp.clearContents();
                        return MoveOrStoreContentBottomSheet.move(contents: toMove);
                      },
                    );
                  },
                );

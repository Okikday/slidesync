        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              ...
              colors: [
                Colors.blue.withValues(alpha: gradientAnimation.value),
                Colors.purple.withValues(alpha: gradientAnimation.value),
                Colors.redAccent.withValues(alpha: gradientAnimation.value),
              ],

...
class SettingsAppearanceDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SettingsAppearanceDialog> createState() =>
      _SettingsAppearanceDialogState();
}

class _SettingsAppearanceDialogState
    extends ConsumerState<SettingsAppearanceDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final isNotAdaptiveDarkTheme = theme.brightness == Brightness.dark;

    return AppCustomizableDialog(
      blurSigma: const Offset(2, 2),
      leading: Center(
        child: CustomText("Adjust Theme", color: theme.onSurface),
      ),
      child: Padding(
        ...
        child: SingleChildScrollView(
          ...
          child: Consumer(
            builder: (context, ref, child) {
              final usb = ThemePod.me
                  .select((s) => s.useSystemBrightness)
                  .watch(ref);
              return Column(
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      Builder(
                        builder: (context) {
                          if (usb) return const SizedBox();
                          return ToggleButtons(
                            isSelected: [
                              !isNotAdaptiveDarkTheme,
                              isNotAdaptiveDarkTheme,
                            ],
                            onPressed: (index) {
                              if (usb) return;
                              final curr = ref.read(ThemePod.me).theme;
                              ref
                                  .read(ThemePod.me.notifier)
                                  .setTheme(
                                    curr.copyWith(
                                      currentBrightness: index == 0
                                          ? Brightness.light
                                          : Brightness.dark,
                                    ),
                                  );
                      ...
                      return ThemePairPicker(
                        ...
                        onSelected: (pair, chosen) {
                          ...
                          ref
                              .read(ThemePod.me.notifier)
                              .setTheme(
                                curr.copyWith(currentBrightness: chosen),
                              );
                        },
                      );
                    },
...
class ThemePair {
  ...
  factory ThemePair.fromUnified(UnifiedThemeModel unified) {
    return ThemePair(
      id: unified.currentTheme.title,
      title: unified.currentTheme.title,
...
class ThemePairPicker extends ConsumerWidget {
  ...
  Future<void> _applyPair(
    ...
    try {
      ref
          .read(ThemePod.me.notifier)
          .setTheme(pair.unifiedModel.copyWith(currentBrightness: chosen));
    } catch (_) {
            ...
            child: Container(
              ...
              child: Center(
                child: Text(
                  'L',
                  style: TextStyle(
                    color: pair.lightModel.onPrimary,
            ...
            child: Container(
              ...
              child: Center(
                child: Text(
                  'D',
                  style: TextStyle(
                    color: pair.darkModel.onPrimary,
                    fontWeight: FontWeight.bold,
                    fontSize: 16,
                  ),
                ),
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final currentTheme = ref.watch(ThemePod.me).theme;
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final isSelected = currentTheme.currentTheme.title == pair.title;
          ...
          child: GestureDetector(
            onTap: () async {
              await _applyPair(
                ...
                ref,
                pair,
                currentTheme.currentBrightness,
              );
            },
            child: Material(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  border: isSelected
                      ? Border.all(
                          color: currentTheme.currentTheme.primary,
                          width: 2.5,
                        )
                      : null,
                ),
                      ...
                      Text(
                        ...
                        style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                          fontWeight: isSelected
                              ...
                              : FontWeight.w600,
                          color: isSelected
                              ? currentTheme.currentTheme.primary
                              : currentTheme.currentTheme.onSurface,
                        ),
                      ),
                      ...
                      Row(
                        ...
                        children: [
                          Icon(
                            Icons.circle,
                            size: 10,
                            color: pair.lightModel.primary,
                          ),
                          const SizedBox(width: 6),
                          Icon(
                            Icons.circle,
                            size: 10,
                            color: pair.darkModel.primary,
                          ),
                        ],
                      ),
                    ],

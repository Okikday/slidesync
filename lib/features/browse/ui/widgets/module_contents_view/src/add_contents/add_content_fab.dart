...
import 'package:slidesync/features/browse/ui/widgets/module_contents_view/src/materials_search_button.dart';
...
class AddContentFAB extends ConsumerWidget {
  ...
  const AddContentFAB({super.key, required this.collection, required this.isScrolledNotifier});
  @override
    ...
    return ValueListenableBuilder(
      ...
      builder: (context, isScrolled, child) {
        if (isScrolled) {
          return BuildButton(
            onTap: () {
              PrimaryScrollController.of(context).animateTo(0, duration: Durations.short1, curve: Curves.easeInOut);
            },

...
class CollectionMaterialsPagination extends LeakPrevention {
  ...
  CollectionMaterialsPagination._(this.parentId, {required this.sortOption}) {
  ...
  static CollectionMaterialsPagination of(String parentId, {CourseSortOption? sortOption}) =>
      CollectionMaterialsPagination._(parentId, sortOption: sortOption ?? CourseSortOption.dateModifiedDesc);
